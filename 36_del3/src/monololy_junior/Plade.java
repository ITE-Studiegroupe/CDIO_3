...
public class Plade {
	...
	private void bygFelter() {
		...
		felter[3] = new Felt_Chance(3, Tekst.TekstFeltNavne.TEKSTER[3], Color.GRAY, Color.ORANGE);
		...
		felter[6] = new Felt_Fængsel(6, Tekst.TekstFeltNavne.TEKSTER[6], true, Color.BLACK, Color.WHITE);
		...
		felter[9] = new Felt_Chance(9, Tekst.TekstFeltNavne.TEKSTER[9], Color.GRAY, Color.ORANGE);
		...
		felter[12] = new Felt_Helle(12, Tekst.TekstFeltNavne.TEKSTER[12], Color.WHITE, Color.BLACK);
		...
		felter[15] = new Felt_Chance(15, Tekst.TekstFeltNavne.TEKSTER[15], Color.GRAY, Color.ORANGE);
		...
		felter[18] = new Felt_Fængsel(18, Tekst.TekstFeltNavne.TEKSTER[18], false, Color.BLACK, Color.WHITE);
		...
		felter[21] = new Felt_Chance(21, Tekst.TekstFeltNavne.TEKSTER[21], Color.GRAY, Color.ORANGE);
